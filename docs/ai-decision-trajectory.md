...
- Slice 3 completed on the current branch: deterministic opponent prediction and one-turn projection terms now feed `decision-trace.v5` scoring, including full selected-action weight breakdowns, and scenario coverage.
